...
carthage build --no-skip-current --cache-builds --platform iOS,tvOS
echo ""
...
set -o pipefail && xcodebuild -project "Carthage Project/AnimatableStackView.xcodeproj" -sdk iphonesimulator -scheme "Example" -destination "platform=iOS Simulator,id=${simulator_id}" test | xcpretty
